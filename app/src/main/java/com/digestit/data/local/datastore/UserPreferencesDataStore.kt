...
class UserPreferencesDataStore @Inject constructor(
    ...
    val customAiApiKey:   Flow<String> = context.dataStore.data.map { it[KEY_CUSTOM_AI_API_KEY]  ?: "" }
    ...
    suspend fun setOpenAiApiKey(key: String)    { context.dataStore.edit { it[KEY_OPENAI_API_KEY]     = key } }
    suspend fun setClaudeApiKey(key: String)    { context.dataStore.edit { it[KEY_CLAUDE_API_KEY]     = key } }
    suspend fun setBackendUrl(url: String)      { context.dataStore.edit { it[KEY_BACKEND_URL]        = url } }
    ...
    suspend fun setCustomAiBaseUrl(url: String) { context.dataStore.edit { it[KEY_CUSTOM_AI_BASE_URL] = url } }
    suspend fun setCustomAiModel(model: String) { context.dataStore.edit { it[KEY_CUSTOM_AI_MODEL]    = model } }
    suspend fun setCustomAiApiKey(key: String)  { context.dataStore.edit { it[KEY_CUSTOM_AI_API_KEY]  = key } }
    suspend fun setDeepseekApiKey(key: String)  { context.dataStore.edit { it[KEY_DEEPSEEK_API_KEY]   = key } }
    suspend fun setDeepseekBaseUrl(url: String) { context.dataStore.edit { it[KEY_DEEPSEEK_BASE_URL]  = url } }
